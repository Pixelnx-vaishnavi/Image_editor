...
class ImageEditorScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    _controller.controller = LindiController(
      ...
      icons: [
        LindiStickerIcon(
          icon: Icons.rotate_90_degrees_ccw,iconColor: Colors.purple,
        ...
        LindiStickerIcon(
            ...
            onTap: () {
              ...
              // _controller.controller.selectedWidget!.lock();
            }),
        LindiStickerIcon(
            icon: Icons.close,
              ...
              return Obx(() {
                ...
                return Stack(
                  children: [
                          ...
                          child: Column(
                            children: [
                              ...
                              if (!_controller.showEditOptions.value &&
                                  ...
                                  !_controller.showStickerEditOptions.value &&
                                  !_controller.showtuneOptions.value &&
                                  !_controller.TextEditOptions.value&&!_controller.CameraEditSticker.value)
                    ...
                    //   print('${textEditorControllerWidget.text.length}');
                    //   return  Stack(
                    //     clipBehavior: Clip.none,
